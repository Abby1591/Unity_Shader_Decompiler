    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program3Output frag(program3Input i)
            {
                ...
                float4 r1_xyzw_2 = _MainTex.Sample(sampler_MainTex, (r0_zw_3.xyxx).xy);
                float r0_z_4 = dot(r1_xyzw_2.xyzx, float4(0.299, 0.587, 0.114, 0));
                float r0_w_4 = (r0_z_4 + r0_y_3);
                float4 r1_xyzw_3 = _MainTex.Sample(sampler_MainTex, (i.texcoord0.zwzz).xy);
                ...
                float4 r3_xyzw_3 = _MainTex.Sample(sampler_MainTex, (r2_xyzw_6.xyxx).xy);
                float4 r2_xyzw_7 = _MainTex.Sample(sampler_MainTex, (r2_xyzw_6.zwzz).xy);
                ...
                float4 r3_xyzw_4 = _MainTex.Sample(sampler_MainTex, (i.texcoord0.xyxx).xy);
