    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program3Output frag(program3Input i)
            {
                ...
                if (r0_y_3)
                {
                    o.sv_Target0.xyzw = t0.Sample(s0, i.texcoord4.xyxx);
                ...
                else
                {
                    ...
                    float4 r0_xyzw_8 = t0.Sample(s0, float4(r0_x_7, r0_y_5, r0_x_7, r0_x_7));
