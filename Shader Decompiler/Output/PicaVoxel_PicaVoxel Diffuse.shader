Shader "PicaVoxel/PicaVoxel Diffuse"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            cbuffer _UnityProbeVolumeCB_b2
            {
            ...
            program31Output frag(program31Input i)
            {
                ...
                if (r0_w_1)
                {
                    ...
                    float4 r1_xyzw_9 = t0.Sample(sampler_linear_clamp, (float4(r1_x_8, r1_z_8, r1_w_2, r1_x_8)).xyz);
                    r1_x_10 = r1_xyzw_9.x;
                    r1_y_11 = r1_xyzw_9.y;
                    r1_z_10 = r1_xyzw_9.z;
                    r1_w_4 = r1_xyzw_9.w;
                ...
                float r0_w_5 = saturate(dot(float4(r1_x_10, r1_y_11, r1_z_10, r1_w_4), unity_OcclusionMaskSelector));
                float4 r1_xyzw_11 = (r0_w_5.xxxx * unity_ObjectToWorld[2].xyzx);
                ...
                o.sv_Target0.xyz = ((r0_w_7.xxxx * ((((i.color0.xyzx * unity_WorldToObject[0].xyzx)).xyzx * float4(r1_x_11, r1_y_12, r1_z_11, r1_x_11))).xyzx)).xyz;
                o.sv_Target0.w = 1;
                return o;
            }
            ENDHLSL
        ...
        Pass
        {
            ...
            program20Output vert(program20Input i)
            {
                ...
                o.texcoord0.xyz = unitWorldNormal_xyz_3.xyz;
                o.color0.xyzw = i.color0.xyzw;
            ...
            program38Output frag(program38Input i)
            {
                ...
                float3 r0_xyz_1 = ((i.color0.xyzx * unity_WorldToObject[0].xyzx)).xyz;
                ...
                float r0_w_3 = saturate(mad(r0_w_2, cb3_values[24].z, cb3_values[24].w));
                ...
                if (r1_x_6)
                {
                    ...
                    float4 r2_xyzw_8 = t1.Sample(sampler_linear_clamp, (float4(r2_x_7, r2_z_7, r2_w_2, r2_x_7)).xyz);
                    r2_x_9 = r2_xyzw_8.x;
                    r2_y_9 = r2_xyzw_8.y;
                    r2_z_9 = r2_xyzw_8.z;
                    r2_w_4 = r2_xyzw_8.w;
                ...
                float r1_y_8 = saturate(dot(float4(r2_x_9, r2_y_9, r2_z_9, r2_w_4), cb2_values[46].xyzw));
                float4 r1_xyzw_7 = (i.texcoord4.xxxy / i.texcoord4.wwww);
                float r1_z_7 = r1_xyzw_7.z;
                float r1_w_4 = r1_xyzw_7.w;
                float4 r2_xyzw_10 = t0.Sample(sampler_linear_clamp1, (float4(r1_z_7, r1_w_4, r1_z_7, r1_z_7)).xy);
                float r1_y_9 = (r1_y_8 + -r2_xyzw_10.x);
                float r0_w_4 = mad(r0_w_3, r1_y_9, r2_xyzw_10.x);
                float4 r1_xyzw_10 = (r0_w_4.xxxx * unity_ObjectToWorld[2].xxyz);
                ...
                if ((r1_x_6 != 0))
                {
                    ...
                    float4 r3_xyzw_2 = t1.Sample(sampler_linear_clamp, (float4(r2_x_18, r2_z_18, r2_w_7, r2_x_18)).xyz);
                    float4 r4_xyzw_2 = t1.Sample(sampler_linear_clamp, (((float4(r2_x_18, r2_z_18, r2_w_7, r2_x_18) + float4(0.25, 0, 0, 0))).xyzx).xyz);
                    ...
                    float4 r2_xyzw_20 = t1.Sample(sampler_linear_clamp, (float4(r2_x_19, r2_y_20, r2_z_19, r2_x_19)).xyz);
                    float3 TEXCOORD0_xyz_1 = i.texcoord0.xyz;
                    float r5_w_1 = 1;
                ...
                {
                    float3 TEXCOORD0_xyz_11 = i.texcoord0.xyz;
                    float r2_w_6 = 1;
                ...
                float r0_w_15 = saturate(mad(r0_w_14, cb5_values[1].z, cb5_values[1].w));
        ...
        Pass
        {
            ...
            program37Output frag(program37Input i)
            {
                ...
                if ((cb6_values[0].x == 1))
                {
                    ...
                    float4 r1_xyzw_12 = t1.Sample(sampler_linear_clamp, (float4(r1_x_11, r1_z_10, r1_w_6, r1_x_11)).xyz);
                ...
                float4 r2_xyzw_4 = t0.Sample(sampler_linear_clamp1, (float4(r1_y_14, r1_z_13, r1_y_14, r1_y_14)).xy);
                float r0_w_4 = mad(r0_w_3, (saturate(dot(float4(r1_x_13, r1_y_13, r1_z_12, r1_w_8), cb2_values[46].xyzw)) + -r2_xyzw_4.x), r2_xyzw_4.x);
                float4 r1_xyzw_16 = (r0_w_4.xxxx * unity_ObjectToWorld[2].xyzx);
                ...
                float r1_x_21 = saturate(mad(max((((i.texcoord3.x / cb1_values[5].y) + 1) * cb1_values[5].z), 0), cb5_values[1].z, cb5_values[1].w));
                o.sv_Target0.xyz = (mad(r1_x_21.xxxx, (mad(((((i.color0.xyzx * unity_WorldToObject[0].xyzx)).xyzx * float4(r1_x_16, r1_y_15, r1_z_14, r1_x_16))).xyzx, r0_w_6.xxxx, -cb5_values[0].xyzx)).xyzx, cb5_values[0].xyzx)).xyz;
                o.sv_Target0.w = 1;
                return o;
            }
            ENDHLSL
        ...
        Pass
        {
            ...
            program36Output frag(program36Input i)
            {
                ...
                float r0_w_8 = saturate(i.texcoord3.x);
                o.sv_Target0.xyz = (mad(r0_w_8.xxxx, (((mad(float4(r1_x_12, r1_y_13, r1_z_12, r1_x_12), r0_w_7.xxxx, ((r0_xyz_1.xyzx * i.texcoord2.xyzx)).xyzx)).xyzx + -unity_ProbeVolumeParams.xyzx)).xyzx, unity_ProbeVolumeParams.xyzx)).xyz;
                o.sv_Target0.w = 1;
                return o;
            }
            ENDHLSL
        ...
        Pass
        {
            ...
            program35Output frag(program35Input i)
            {
                ...
                float r0_w_6 = dot(i.texcoord0.xyzx, _WorldSpaceLightPos0.xyzx);
                float r0_w_7 = max(r0_w_6, 0);
                o.sv_Target0.xyz = (mad((saturate(i.texcoord3.x)).xxxx, (mad(((((i.color0.xyzx * unity_WorldToObject[0].xyzx)).xyzx * float4(r1_x_11, r1_y_12, r1_z_11, r1_x_11))).xyzx, r0_w_7.xxxx, -unity_ProbeVolumeParams.xyzx)).xyzx, unity_ProbeVolumeParams.xyzx)).xyz;
                o.sv_Target0.w = 1;
                return o;
            }
            ENDHLSL
        ...
        Pass
        {
            ...
            program33Output frag(program33Input i)
            {
                ...
                float r0_w_5 = dot(i.texcoord0.xyzx, unity_ProbeVolumeParams.xyzx);
                float r0_w_6 = max(r0_w_5, 0);
                o.sv_Target0.xyz = ((r0_w_6.xxxx * ((((i.color0.xyzx * unity_WorldToObject[0].xyzx)).xyzx * float4(r1_x_16, r1_y_15, r1_z_14, r1_x_16))).xyzx)).xyz;
                o.sv_Target0.w = 1;
                return o;
            }
            ENDHLSL
        ...
        Pass
        {
            ...
            program55Output frag(program55Input i)
            {
                ...
                if (r0_w_3)
                {
                    ...
                    float4 r3_xyzw_9 = t1.Sample(sampler_linear_clamp, (float4(r3_x_8, r3_z_8, r3_w_2, r3_x_8)).xyz);
                    r3_x_10 = r3_xyzw_9.x;
                    r3_y_10 = r3_xyzw_9.y;
                    r3_z_10 = r3_xyzw_9.z;
                    r3_w_4 = r3_xyzw_9.w;
                ...
                float4 r2_xyzw_5 = t0.Sample(sampler_linear_clamp1, (r1_w_3.xxxx).xy);
                float r0_w_8 = (r0_w_7 * r2_xyzw_5.x);
                float4 r0_xyzw_3 = (((i.color0.xyzx * cb0_values[8].xyzx)).xxyz * ((r0_w_8.xxxx * unity_ObjectToWorld[2].xyzx)).xxyz);
        ...
        Pass
        {
            ...
            program64Output frag(program64Input i)
            {
                ...
                if (r0_w_1)
                {
                    ...
                    float4 r2_xyzw_9 = t1.Sample(sampler_linear_clamp, (float4(r2_x_8, r2_z_8, r2_w_2, r2_x_8)).xyz);
                    r2_x_10 = r2_xyzw_9.x;
                    r2_y_10 = r2_xyzw_9.y;
                    r2_z_10 = r2_xyzw_9.z;
                    r2_w_4 = r2_xyzw_9.w;
                ...
                float r0_w_5 = saturate(dot(float4(r2_x_10, r2_y_10, r2_z_10, r2_w_4), unity_OcclusionMaskSelector));
                float4 r1_xyzw_5 = t0.Sample(sampler_linear_clamp1, ((((mad(cb0_values[6].xyxx, i.texcoord1.zzzz, (mad(cb0_values[4].xyxx, i.texcoord1.xxxx, ((i.texcoord1.yyyy * cb0_values[5].xyxx)).xyxx)).xyxx)).xyxx + cb0_values[7].xyxx)).xyxx).xy);
                float r0_w_6 = (r0_w_5 * r1_xyzw_5.w);
                float4 r1_xyzw_6 = (r0_w_6.xxxx * unity_ObjectToWorld[2].xyzx);
                ...
                float r0_w_9 = saturate(i.texcoord4.x);
                o.sv_Target0.xyz = ((((r0_w_8.xxxx * ((((i.color0.xyzx * cb0_values[8].xyzx)).xyzx * float4(r1_x_6, r1_y_6, r1_z_4, r1_x_6))).xyzx)).xyzx * r0_w_9.xxxx)).xyz;
                o.sv_Target0.w = 1;
                return o;
            }
            ENDHLSL
        ...
        Pass
        {
            ...
            program63Output frag(program63Input i)
            {
                ...
                if (r0_w_3)
                {
                    ...
                    float r1_w_1 = mad(unity_ProbeVolumeParams.z, 0.5, 0.75);
                    float r3_x_8 = max(r0_w_5, r1_w_1);
                    float4 r3_xyzw_9 = t2.Sample(sampler_linear_clamp, (float4(r3_x_8, r3_z_8, r3_w_2, r3_x_8)).xyz);
                    r3_x_10 = r3_xyzw_9.x;
                    r3_y_10 = r3_xyzw_9.y;
                    r3_z_10 = r3_xyzw_9.z;
                    r3_w_4 = r3_xyzw_9.w;
                ...
                float r0_w_7 = saturate(dot(float4(r3_x_10, r3_y_10, r3_z_10, r3_w_4), unity_OcclusionMaskSelector));
                float r1_w_3 = dot(r2_xyz_4.xyzx, r2_xyz_4.xyzx);
                float4 r3_xyzw_11 = t0.Sample(sampler_linear_clamp2, (r1_w_3.xxxx).xy);
                float4 r2_xyzw_5 = t1.Sample(sampler_linear_clamp1, r2_xyz_4.xyz);
        ...
        Pass
        {
            ...
            program62Output frag(program62Input i)
            {
                ...
                float4 r3_xyzw_13 = t0.Sample(sampler_linear_clamp1, (((((r2_xyzw_4.xyxx / r2_xyzw_4.wwww)).xyxx + float4(0.5, 0.5, 0, 0))).xyxx).xy);
                float r1_w_5 = (r1_w_4 * r3_xyzw_13.w);
                float4 r2_xyzw_6 = t1.Sample(sampler_linear_clamp2, ((dot(r2_xyzw_4.xyzx, r2_xyzw_4.xyzx)).xxxx).xy);
                float r1_w_6 = (r1_w_5 * r2_xyzw_6.x);
                float r0_w_8 = (r0_w_7 * r1_w_6);
                float4 r2_xyzw_7 = (r0_w_8.xxxx * unity_ObjectToWorld[2].xyzx);
        ...
        Pass
        {
            ...
            program61Output frag(program61Input i)
            {
                ...
                o.sv_Target0.xyz = ((((r0_w_7.xxxx * ((((i.color0.xyzx * cb0_values[4].xyzx)).xyzx * float4(r1_x_11, r1_y_12, r1_z_11, r1_x_11))).xyzx)).xyzx * r0_w_8.xxxx)).xyz;
                o.sv_Target0.w = 1;
                return o;
            }
            ENDHLSL
        ...
        Pass
        {
            ...
            program70Output frag(program70Input i)
            {
                ...
                o.sv_Target0.xyz = ((i.color0.xyzx * unity_WorldToObject[0].xyzx)).xyz;
                o.sv_Target0.w = 1;
