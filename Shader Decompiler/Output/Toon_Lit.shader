    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program32Output frag(program32Input i)
            {
                ...
                if (r0_w_2)
                {
                    ...
                    float4 r1_xyzw_9 = t2.Sample(s0, float4(r1_x_8, r1_z_8, r1_w_2, r1_x_8));
                    r1_x_10 = r1_xyzw_9.x;
                    r1_y_11 = r1_xyzw_9.y;
                    r1_z_10 = r1_xyzw_9.z;
                    r1_w_4 = r1_xyzw_9.w;
                ...
                float4 r1_xyzw_13 = t1.Sample(s1, (mad(dot(i.texcoord1.xyzx, _WorldSpaceLightPos0.xyzx), 0.5, 0.5)).xxxx);
        ...
        Pass
        {
            ...
            program27Output vert(program27Input i)
            {
                ...
                o.texcoord5.zw = (clipPos_xyzw_2.zzzw).zw;
                o.texcoord0.xy = (mad(i.texcoord0.xyxx, _MainTex_ST.xyxx, _MainTex_ST.zwzz)).xy;
                float worldNormal_x_4 = dot(i.normal0.xyzx, cb3_values[4].xyzx);
                float worldNormal_y_4 = dot(i.normal0.xyzx, cb3_values[5].xyzx);
                float worldNormal_z_4 = dot(i.normal0.xyzx, cb3_values[6].xyzx);
                ...
                o.texcoord1.xyz = (unitWorldNormal_xyz_5.xyzx).xyz;
                o.texcoord2.xyz = (r0_xyz_4.xyzx).xyz;
                float r0_w_6 = (unitWorldNormal_xyz_5.y * unitWorldNormal_xyz_5.y);
                float r0_w_7 = mad(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.x, -r0_w_6);
                float4 r3_xyzw_1 = (unitWorldNormal_xyz_5.yzzx * unitWorldNormal_xyz_5.xyzz);
                ...
                float r2_w_4 = 1;
                float r4_x_2 = dot(cb2_values[39].xyzw, float4(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.y, unitWorldNormal_xyz_5.z, r2_w_4));
                float r4_y_2 = dot(cb2_values[40].xyzw, float4(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.y, unitWorldNormal_xyz_5.z, r2_w_4));
                float r4_z_2 = dot(cb2_values[41].xyzw, float4(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.y, unitWorldNormal_xyz_5.z, r2_w_4));
                float3 r3_xyz_6 = (((log2((max((((mad(cb2_values[45].xyzx, r0_w_7.xxxx, float4(r4_x_1, r4_y_1, r4_z_1, r4_x_1))).xyzx + float4(r4_x_2, r4_y_2, r4_z_2, r4_x_2))).xyzx, float4(0, 0, 0, 0))).xyzx)).xyzx * float4(0.41666666, 0.41666666, 0.41666666, 0))).xyz;
                float4 r4_xyzw_3 = (-r0_xyz_4.yyyy + cb2_values[4].xyzw);
                float4 r4_xyzw_4 = (r4_xyzw_3 * r4_xyzw_3);
                float4 r6_xyzw_1 = (-r0_xyz_4.xxxx + cb2_values[3].xyzw);
                float4 r0_xyzw_5 = (-r0_xyz_4.zzzz + cb2_values[5].xyzw);
                float4 r2_xyzw_6 = mad(r0_xyzw_5, unitWorldNormal_xyz_5.zzzz, mad(r6_xyzw_1, unitWorldNormal_xyz_5.xxxx, (unitWorldNormal_xyz_5.yyyy * r4_xyzw_3)));
                float4 r4_xyzw_5 = mad(r6_xyzw_1, r6_xyzw_1, r4_xyzw_4);
                float4 r0_xyzw_6 = mad(r0_xyzw_5, r0_xyzw_5, r4_xyzw_5);
                float4 r0_xyzw_7 = max(r0_xyzw_6, float4(1E-06, 1E-06, 1E-06, 1E-06));
                float4 r4_xyzw_6 = rsqrt(r0_xyzw_7);
                float4 r0_xyzw_8 = mad(r0_xyzw_7, cb2_values[6].xyzw, float4(1, 1, 1, 1));
                float4 r0_xyzw_9 = (float4(1, 1, 1, 1) / r0_xyzw_8);
                float4 r2_xyzw_7 = (r2_xyzw_6 * r4_xyzw_6);
                float4 r2_xyzw_8 = max(r2_xyzw_7, float4(0, 0, 0, 0));
                float4 r0_xyzw_10 = (r0_xyzw_9 * r2_xyzw_8);
                ...
                o.texcoord3.xyz = ((r0_xyz_12.xyzx + (max((mad((exp2(r3_xyz_6.xyzx)).xyzx, float4(1.055, 1.055, 1.055, 0), float4(-0.055, -0.055, -0.055, 0))).xyzx, float4(0, 0, 0, 0))).xyzx)).xyz;
                float2 r1_xz_3 = ((clipPos_xyzw_2.xxwx * float4(0.5, 0, 0.5, 0))).xz;
                float r1_w_3 = ((clipPos_xyzw_2.y * unity_WorldToObject[1].x) * 0.5);
                o.texcoord5.xy = ((r1_xz_3.yyyy + float4(r1_xz_3.x, r1_w_3, r1_xz_3.x, r1_xz_3.x))).xy;
            ...
            program38Output frag(program38Input i)
            {
                ...
                float4 r0_xyzw_1 = t0.Sample(s3, i.texcoord0.xyxx);
                float3 r0_xyz_2 = ((r0_xyzw_1.xyzx * _Color.xyzx)).xyz;
                ...
                if ((cb6_values[0].x == 1))
                {
                    ...
                    float4 r1_xyzw_12 = t3.Sample(s0, float4(r1_x_11, r1_z_10, r1_w_6, r1_x_11));
                ...
                float4 r2_xyzw_4 = t1.Sample(s1, float4(r1_y_14, r1_z_13, r1_y_14, r1_y_14));
                float r0_w_5 = mad(r0_w_4, (dot(float4(r1_x_13, r1_y_13, r1_z_12, r1_w_8), cb2_values[46].xyzw) + -r2_xyzw_4.x), r2_xyzw_4.x);
                float4 r1_xyzw_18 = t2.Sample(s2, (mad(dot(i.texcoord1.xyzx, unity_ProbeVolumeParams.xyzx), 0.5, 0.5)).xxxx);
        ...
        Pass
        {
            ...
            program26Output vert(program26Input i)
            {
                ...
                o.texcoord1.xyz = (unitWorldNormal_xyz_5.xyzx).xyz;
                o.texcoord2.xyz = (r0_xyz_4.xyzx).xyz;
                float4 r3_xyzw_1 = (-r0_xyz_4.yyyy + cb2_values[4].xyzw);
                float4 r5_xyzw_1 = (-r0_xyz_4.xxxx + cb2_values[3].xyzw);
                float4 r0_xyzw_5 = (-r0_xyz_4.zzzz + cb2_values[5].xyzw);
                float4 r2_xyzw_6 = mad(r0_xyzw_5, unitWorldNormal_xyz_5.zzzz, mad(r5_xyzw_1, unitWorldNormal_xyz_5.xxxx, (unitWorldNormal_xyz_5.yyyy * r3_xyzw_1)));
                float4 r0_xyzw_6 = mad(r0_xyzw_5, r0_xyzw_5, mad(r5_xyzw_1, r5_xyzw_1, (r3_xyzw_1 * r3_xyzw_1)));
                float4 r0_xyzw_7 = max(r0_xyzw_6, float4(1E-06, 1E-06, 1E-06, 1E-06));
                float4 r0_xyzw_8 = mad(r0_xyzw_7, cb2_values[6].xyzw, float4(1, 1, 1, 1));
                float4 r0_xyzw_9 = (float4(1, 1, 1, 1) / r0_xyzw_8);
                float4 r2_xyzw_7 = (r2_xyzw_6 * rsqrt(r0_xyzw_7));
                float4 r2_xyzw_8 = max(r2_xyzw_7, float4(0, 0, 0, 0));
                float4 r0_xyzw_10 = (r0_xyzw_9 * r2_xyzw_8);
                o.texcoord3.xyz = (mad(cb2_values[10].xyzx, r0_xyzw_10.wwww, (mad(cb2_values[9].xyzx, r0_xyzw_10.zzzz, (mad(cb2_values[7].xyzx, r0_xyzw_10.xxxx, ((r0_xyzw_10.yyyy * cb2_values[8].xyzx)).xyzx)).xyzx)).xyzx)).xyz;
                float2 r1_xz_3 = ((clipPos_xyzw_2.xxwx * float4(0.5, 0, 0.5, 0))).xz;
                float r1_w_3 = ((clipPos_xyzw_2.y * unity_WorldToObject[1].x) * 0.5);
                o.texcoord5.xy = ((r1_xz_3.yyyy + float4(r1_xz_3.x, r1_w_3, r1_xz_3.x, r1_xz_3.x))).xy;
                o.texcoord6.xyzw = float4(0, 0, 0, 0);
        ...
        Pass
        {
            ...
            program25Output vert(program25Input i)
            {
                ...
                float3 r0_xyz_12 = (mad(cb2_values[10].xyzx, r0_xyzw_10.wwww, (mad(cb2_values[9].xyzx, r0_xyzw_10.zzzz, (mad(cb2_values[7].xyzx, r0_xyzw_10.xxxx, ((r0_xyzw_10.yyyy * cb2_values[8].xyzx)).xyzx)).xyzx)).xyzx)).xyz;
                o.texcoord3.xyz = ((r0_xyz_12.xyzx + (max((mad((exp2(r2_xyz_9.xyzx)).xyzx, float4(1.055, 1.055, 1.055, 0), float4(-0.055, -0.055, -0.055, 0))).xyzx, float4(0, 0, 0, 0))).xyzx)).xyz;
                o.texcoord5.xyzw = float4(0, 0, 0, 0);
                return o;
            }
            #pragma fragment frag
        ...
        Pass
        {
            ...
            program24Output vert(program24Input i)
            {
                ...
                o.texcoord1.xyz = (unitWorldNormal_xyz_4.xyzx).xyz;
                o.texcoord2.xyz = (r0_xyz_4.xyzx).xyz;
                float4 r2_xyzw_4 = (-r0_xyz_4.yyyy + cb2_values[4].xyzw);
                float4 r4_xyzw_1 = (-r0_xyz_4.xxxx + cb2_values[3].xyzw);
                float4 r0_xyzw_5 = (-r0_xyz_4.zzzz + cb2_values[5].xyzw);
                float4 r1_xyzw_5 = mad(r0_xyzw_5, unitWorldNormal_xyz_4.zzzz, mad(r4_xyzw_1, unitWorldNormal_xyz_4.xxxx, (unitWorldNormal_xyz_4.yyyy * r2_xyzw_4)));
                float4 r0_xyzw_6 = mad(r0_xyzw_5, r0_xyzw_5, mad(r4_xyzw_1, r4_xyzw_1, (r2_xyzw_4 * r2_xyzw_4)));
                float4 r0_xyzw_7 = max(r0_xyzw_6, float4(1E-06, 1E-06, 1E-06, 1E-06));
                float4 r0_xyzw_8 = mad(r0_xyzw_7, cb2_values[6].xyzw, float4(1, 1, 1, 1));
                float4 r0_xyzw_9 = (float4(1, 1, 1, 1) / r0_xyzw_8);
                float4 r1_xyzw_6 = (r1_xyzw_5 * rsqrt(r0_xyzw_7));
                float4 r1_xyzw_7 = max(r1_xyzw_6, float4(0, 0, 0, 0));
                float4 r0_xyzw_10 = (r0_xyzw_9 * r1_xyzw_7);
                o.texcoord3.xyz = (mad(cb2_values[10].xyzx, r0_xyzw_10.wwww, (mad(cb2_values[9].xyzx, r0_xyzw_10.zzzz, (mad(cb2_values[7].xyzx, r0_xyzw_10.xxxx, ((r0_xyzw_10.yyyy * cb2_values[8].xyzx)).xyzx)).xyzx)).xyzx)).xyz;
                o.texcoord5.xyzw = float4(0, 0, 0, 0);
        ...
        Pass
        {
            ...
            program19Output vert(program19Input i)
            {
                ...
                o.texcoord5.zw = (clipPos_xyzw_2.zzzw).zw;
                o.texcoord5.xy = ((r0_z_13.xxxx + float4(r0_x_14, r0_w_14, r0_x_14, r0_x_14))).xy;
                o.texcoord6.xyzw = float4(0, 0, 0, 0);
                return o;
            }
            #pragma fragment frag
        ...
        Pass
        {
            ...
            program18Output vert(program18Input i)
            {
                ...
                float4 r0_xyzw_10 = (r0_xyzw_9 * r2_xyzw_8);
                o.texcoord3.xyz = (mad(cb2_values[10].xyzx, r0_xyzw_10.wwww, (mad(cb2_values[9].xyzx, r0_xyzw_10.zzzz, (mad(cb2_values[7].xyzx, r0_xyzw_10.xxxx, ((r0_xyzw_10.yyyy * cb2_values[8].xyzx)).xyzx)).xyzx)).xyzx)).xyz;
                float r0_w_12 = ((clipPos_xyzw_2.y * unity_WorldToObject[1].x) * 0.5);
                float4 r0_xyzw_13 = (clipPos_xyzw_2.xxwx * float4(0.5, 0, 0.5, 0));
                float r0_x_13 = r0_xyzw_13.x;
                float r0_z_12 = r0_xyzw_13.z;
                o.texcoord5.zw = (clipPos_xyzw_2.zzzw).zw;
                o.texcoord5.xy = ((r0_z_12.xxxx + float4(r0_x_13, r0_w_12, r0_x_13, r0_x_13))).xy;
                o.texcoord6.xyzw = float4(0, 0, 0, 0);
                return o;
            }
            #pragma fragment frag
        ...
        Pass
        {
            ...
            program16Output vert(program16Input i)
            {
                ...
                o.texcoord1.xyz = (unitWorldNormal_xyz_3.xyzx).xyz;
                o.texcoord2.xyz = (r0_xyz_4.xyzx).xyz;
                float4 r2_xyzw_4 = (-r0_xyz_4.yyyy + unity_WorldToObject[0]);
                float4 r4_xyzw_1 = (-r0_xyz_4.xxxx + unity_ObjectToWorld[3]);
                float4 r0_xyzw_5 = (-r0_xyz_4.zzzz + unity_WorldToObject[1]);
                float4 r1_xyzw_4 = mad(r0_xyzw_5, unitWorldNormal_xyz_3.zzzz, mad(r4_xyzw_1, unitWorldNormal_xyz_3.xxxx, (unitWorldNormal_xyz_3.yyyy * r2_xyzw_4)));
                float4 r0_xyzw_6 = mad(r0_xyzw_5, r0_xyzw_5, mad(r4_xyzw_1, r4_xyzw_1, (r2_xyzw_4 * r2_xyzw_4)));
                float4 r0_xyzw_7 = max(r0_xyzw_6, float4(1E-06, 1E-06, 1E-06, 1E-06));
                float4 r0_xyzw_8 = mad(r0_xyzw_7, unity_WorldToObject[2], float4(1, 1, 1, 1));
                float4 r0_xyzw_9 = (float4(1, 1, 1, 1) / r0_xyzw_8);
                float4 r1_xyzw_5 = (r1_xyzw_4 * rsqrt(r0_xyzw_7));
                float4 r1_xyzw_6 = max(r1_xyzw_5, float4(0, 0, 0, 0));
                float4 r0_xyzw_10 = (r0_xyzw_9 * r1_xyzw_6);
                o.texcoord3.xyz = (mad(cb1_values[10].xyzx, r0_xyzw_10.wwww, (mad(cb1_values[9].xyzx, r0_xyzw_10.zzzz, (mad(unity_WorldToObject[3].xyzx, r0_xyzw_10.xxxx, ((r0_xyzw_10.yyyy * cb1_values[8].xyzx)).xyzx)).xyzx)).xyzx)).xyz;
                o.texcoord5.xyzw = float4(0, 0, 0, 0);
                return o;
            }
            #pragma fragment frag
        ...
        Pass
        {
            ...
            program58Output frag(program58Input i)
            {
                ...
                float4 r2_xyzw_5 = t1.Sample(s1, r1_w_4.xxxx);
                float4 r3_xyzw_11 = t2.Sample(s2, (mad(dot(i.texcoord1.xyzx, ((r0_w_2.xxxx * r0_xyz_1.xyzx)).xyzx), 0.5, 0.5)).xxxx);
        ...
        Pass
        {
            ...
            program67Output frag(program67Input i)
            {
                ...
                if (r0_w_2)
                {
                    ...
                    float4 r2_xyzw_9 = t3.Sample(s0, float4(r2_x_8, r2_z_8, r2_w_2, r2_x_8));
                    r2_x_10 = r2_xyzw_9.x;
                    r2_y_10 = r2_xyzw_9.y;
                    r2_z_10 = r2_xyzw_9.z;
                    r2_w_4 = r2_xyzw_9.w;
                ...
                float4 r1_xyzw_5 = t1.Sample(s1, (((mad(cb0_values[6].xyxx, i.texcoord2.zzzz, (mad(cb0_values[4].xyxx, i.texcoord2.xxxx, ((i.texcoord2.yyyy * cb0_values[5].xyxx)).xyxx)).xyxx)).xyxx + cb0_values[7].xyxx)).xyxx);
                float4 r2_xyzw_11 = t2.Sample(s2, (mad(dot(i.texcoord1.xyzx, _WorldSpaceLightPos0.xyzx), 0.5, 0.5)).xxxx);
        ...
        Pass
        {
            ...
            program66Output frag(program66Input i)
            {
                ...
                float r0_w_1 = dot(r0_xyz_1.xyzx, r0_xyz_1.xyzx);
                float r0_w_2 = rsqrt(r0_w_1);
                float4 r1_xyzw_1 = t0.Sample(s4, i.texcoord0.xyxx);
                float3 r2_xyz_4 = (((mad(cb0_values[6].xyzx, i.texcoord2.zzzz, (mad(cb0_values[4].xyzx, i.texcoord2.xxxx, ((i.texcoord2.yyyy * cb0_values[5].xyzx)).xyzx)).xyzx)).xyzx + cb0_values[7].xyzx)).xyz;
                float r0_w_3 = (unity_ProbeVolumeParams.x == 1);
                float r3_x_10;
                float r3_y_10;
                ...
                if (r0_w_3)
                {
                    ...
                    float r1_w_2 = mad(unity_ProbeVolumeParams.z, 0.5, 0.75);
                    float r3_x_8 = max(r0_w_5, r1_w_2);
                    float4 r3_xyzw_9 = t4.Sample(s0, float4(r3_x_8, r3_z_8, r3_w_2, r3_x_8));
                    r3_x_10 = r3_xyzw_9.x;
                    r3_y_10 = r3_xyzw_9.y;
                    r3_z_10 = r3_xyzw_9.z;
                    r3_w_4 = r3_xyzw_9.w;
                ...
                float r0_w_7 = dot(float4(r3_x_10, r3_y_10, r3_z_10, r3_w_4), unity_OcclusionMaskSelector);
                float r1_w_4 = dot(r2_xyz_4.xyzx, r2_xyz_4.xyzx);
                float4 r3_xyzw_11 = t1.Sample(s2, r1_w_4.xxxx);
                float4 r2_xyzw_5 = t2.Sample(s1, r2_xyz_4.xyzx);
                float r1_w_5 = (r2_xyzw_5.w * r3_xyzw_11.x);
                float4 r2_xyzw_6 = t3.Sample(s3, (mad(dot(i.texcoord1.xyzx, ((r0_w_2.xxxx * r0_xyz_1.xyzx)).xyzx), 0.5, 0.5)).xxxx);
                float4 r0_xyzw_5 = (((r1_xyzw_1.xyzx * cb0_values[8].xyzx)).xyzx * _LightColor0.xyzx);
                float r0_x_5 = r0_xyzw_5.x;
                float r0_y_3 = r0_xyzw_5.y;
                float r0_z_3 = r0_xyzw_5.z;
        ...
        Pass
        {
            ...
            program65Output frag(program65Input i)
            {
                ...
                float4 r3_xyzw_13 = t1.Sample(s1, ((((r2_xyzw_4.xyxx / r2_xyzw_4.wwww)).xyxx + float4(0.5, 0.5, 0, 0))).xyxx);
                float r1_w_6 = (r1_w_5 * r3_xyzw_13.w);
                float4 r2_xyzw_6 = t2.Sample(s2, (dot(r2_xyzw_4.xyzx, r2_xyzw_4.xyzx)).xxxx);
                float r1_w_7 = (r1_w_6 * r2_xyzw_6.x);
                float4 r2_xyzw_7 = t3.Sample(s3, (mad(dot(i.texcoord1.xyzx, ((r0_w_2.xxxx * r0_xyz_1.xyzx)).xyzx), 0.5, 0.5)).xxxx);
                float4 r0_xyzw_5 = (((r1_xyzw_1.xyzx * cb0_values[8].xyzx)).xyzx * _LightColor0.xyzx);
                float r0_x_5 = r0_xyzw_5.x;
                float r0_y_3 = r0_xyzw_5.y;
                float r0_z_3 = r0_xyzw_5.z;
