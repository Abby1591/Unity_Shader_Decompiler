    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program6Output frag(program6Input i)
            {
                ...
                float4 r0_xyzw_1 = _ToonShade.Sample(sampler_ToonShade, i.texcoord1.xyz);
        ...
        Pass
        {
            ...
            program3Output vert(program3Input i)
            {
                ...
                o.sv_Position0.xyzw = mul(float4x4(cb3_values[17], cb3_values[18], cb3_values[19], cb3_values[20]), worldPos_xyzw_4);
