    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program13Output frag(program13Input i)
            {
                ...
                if (r2_w_11)
                {
                    float r2_w_12 = dot(r5_xyz_12.xyzx, r5_xyz_12.xyzx);
                    float r2_w_13 = rsqrt(r2_w_12);
                    float3 r7_xyz_2 = ((r2_w_13.xxxx * r5_xyz_12.xyzx)).xyz;
                ...
                if (r3_w_8)
                {
                    ...
                    if (r3_w_9)
                    {
                        float r3_w_10 = dot(r5_xyz_12.xyzx, r5_xyz_12.xyzx);
                        float r3_w_11 = rsqrt(r3_w_10);
                        float3 r9_xyz_4 = ((r3_w_11.xxxx * r5_xyz_12.xyzx)).xyz;
        ...
        Pass
        {
            ...
            program8Output vert(program8Input i)
            {
                ...
                float r0_w_2 = dot(worldTangent_xyz_7.xyzx, worldTangent_xyz_7.xyzx);
                float r0_w_3 = rsqrt(r0_w_2);
                float3 unitWorldTangent_xyz_8 = ((r0_w_3.xxxx * worldTangent_xyz_7.xyzx)).xyz;
                o.texcoord1.x = unitWorldTangent_xyz_8.z;
                o.texcoord1.w = r0_xyz_3.x;
                float r0_w_4 = (i.tangent0.w * cb2_values[9].w);
                ...
                float r1_w_5 = dot(float4(worldNormal_x_4, worldNormal_y_4, worldNormal_z_4, worldNormal_x_4), float4(worldNormal_x_4, worldNormal_y_4, worldNormal_z_4, worldNormal_x_4));
                float r1_w_6 = rsqrt(r1_w_5);
                float4 unitWorldNormal_xyzw_5 = (r1_w_6.xxxx * float4(worldNormal_x_4, worldNormal_y_4, worldNormal_z_4, worldNormal_z_4));
                float3 r3_xyz_3 = ((r0_w_4.xxxx * (mad(unitWorldNormal_xyzw_5.ywxy, unitWorldTangent_xyz_8.yzxy, ((unitWorldTangent_xyz_8.xyzx * unitWorldNormal_xyzw_5.wxyw)).xyzx)).xyzx)).xyz;
                o.texcoord1.y = r3_xyz_3.x;
                ...
                float4 r1_xyzw_9 = (-r0_xyz_3.xxxx + unity_ObjectToWorld[3]);
                float4 r3_xyzw_4 = (-r0_xyz_3.yyyy + unity_WorldToObject[0]);
                float4 r0_xyzw_4 = (-r0_xyz_3.zzzz + unity_WorldToObject[1]);
                float4 r3_xyzw_5 = (r3_xyzw_4 * r3_xyzw_4);
                float4 r3_xyzw_6 = mad(r1_xyzw_9, r1_xyzw_9, r3_xyzw_5);
                float4 r1_xyzw_10 = mad(r1_xyzw_9, unitWorldNormal_xyzw_5.xxxx, (unitWorldNormal_xyzw_5.yyyy * r3_xyzw_4));
                float4 r1_xyzw_11 = mad(r0_xyzw_4, unitWorldNormal_xyzw_5.wwzw, r1_xyzw_10);
                float4 r0_xyzw_5 = mad(r0_xyzw_4, r0_xyzw_4, r3_xyzw_6);
                float4 r0_xyzw_6 = max(r0_xyzw_5, float4(1E-06, 1E-06, 1E-06, 1E-06));
                float4 r3_xyzw_7 = rsqrt(r0_xyzw_6);
                float4 r0_xyzw_7 = mad(r0_xyzw_6, unity_WorldToObject[2], float4(1, 1, 1, 1));
                float4 r0_xyzw_8 = (float4(1, 1, 1, 1) / r0_xyzw_7);
                float4 r1_xyzw_12 = (r1_xyzw_11 * r3_xyzw_7);
                float4 r1_xyzw_13 = max(r1_xyzw_12, float4(0, 0, 0, 0));
                float4 r0_xyzw_9 = (r0_xyzw_8 * r1_xyzw_13);
                float3 r0_xyz_11 = (mad(cb1_values[10].xyzx, r0_xyzw_9.wwww, (mad(unity_WorldTransformParams.xyzx, r0_xyzw_9.zzzz, (mad(unity_WorldToObject[3].xyzx, r0_xyzw_9.xxxx, ((r0_xyzw_9.yyyy * cb1_values[8].xyzx)).xyzx)).xyzx)).xyzx)).xyz;
                float r0_w_11 = (unitWorldNormal_xyzw_5.y * unitWorldNormal_xyzw_5.y);
                float r0_w_12 = mad(unitWorldNormal_xyzw_5.x, unitWorldNormal_xyzw_5.x, -r0_w_11);
                float4 r2_xyzw_6 = (unitWorldNormal_xyzw_5.ywzx * unitWorldNormal_xyzw_5);
                float r3_x_8 = dot(cb1_values[42].xyzw, r2_xyzw_6);
                float r3_y_8 = dot(cb1_values[43].xyzw, r2_xyzw_6);
                float r3_z_8 = dot(cb1_values[44].xyzw, r2_xyzw_6);
                o.texcoord4.xyz = (mad(r0_xyz_11.xyzx, (mad(r0_xyz_11.xyzx, (mad(r0_xyz_11.xyzx, float4(0.30530602, 0.30530602, 0.30530602, 0), float4(0.6821711, 0.6821711, 0.6821711, 0))).xyzx, float4(0.012522878, 0.012522878, 0.012522878, 0))).xyzx, (mad(cb1_values[45].xyzx, r0_w_12.xxxx, float4(r3_x_8, r3_y_8, r3_z_8, r3_x_8))).xyzx)).xyz;
                o.texcoord7.xyzw = float4(0, 0, 0, 0);
                return o;
            }
            #pragma fragment frag
            program16Output frag(program16Input i)
            {
                ...
                float3 r7_xyz_15 = (exp2((((log2((max(((r8_xyz_4.xyzx + i.texcoord4.xyzx)).xyzx, float4(0, 0, 0, 0))).xyzx)).xyzx * float4(0.41666666, 0.41666666, 0.41666666, 0))).xyzx)).xyz;
        ...
        Pass
        {
            ...
            program5Output vert(program5Input i)
            {
                ...
                float4 r1_xyzw_3 = (r0_xyzw_2 + cb2_values[3].xyzw);
                float3 r0_xyz_3 = (mad(cb2_values[3].xyzx, i.position0.wwww, r0_xyzw_2.xyzx)).xyz;
                o.sv_Position0.xyzw = mad(cb3_values[20].xyzw, r1_xyzw_3.wwww, mad(cb3_values[19].xyzw, r1_xyzw_3.zzzz, mad(cb3_values[17].xyzw, r1_xyzw_3.xxxx, (r1_xyzw_3.yyyy * cb3_values[18].xyzw))));
                o.texcoord0.xy = (mad(i.texcoord0.xyxx, _MainTex_ST.xyxx, _MainTex_ST.zwzz)).xy;
                ...
                float r0_w_2 = dot(worldTangent_xyz_6.xyzx, worldTangent_xyz_6.xyzx);
                float r0_w_3 = rsqrt(r0_w_2);
                float3 unitWorldTangent_xyz_7 = ((r0_w_3.xxxx * worldTangent_xyz_6.xyzx)).xyz;
                o.texcoord1.x = unitWorldTangent_xyz_7.z;
                o.texcoord1.w = r0_xyz_3.x;
                float r0_w_4 = (i.tangent0.w * cb2_values[9].w);
                float worldNormal_x_4 = dot(i.normal0.xyzx, cb2_values[4].xyzx);
                ...
                float4 unitWorldNormal_xyzw_5 = (r1_w_5.xxxx * float4(worldNormal_x_4, worldNormal_y_4, worldNormal_z_4, worldNormal_z_4));
                float3 r3_xyz_3 = ((r0_w_4.xxxx * (mad(unitWorldNormal_xyzw_5.ywxy, unitWorldTangent_xyz_7.yzxy, ((unitWorldTangent_xyz_7.xyzx * unitWorldNormal_xyzw_5.wxyw)).xyzx)).xyzx)).xyz;
                o.texcoord1.y = r3_xyz_3.x;
                o.texcoord1.z = unitWorldNormal_xyzw_5.x;
                o.texcoord2.x = unitWorldTangent_xyz_7.x;
                o.texcoord3.x = unitWorldTangent_xyz_7.y;
                ...
                o.texcoord3.w = r0_xyz_3.z;
                o.texcoord3.z = unitWorldNormal_xyzw_5.w;
                float4 r1_xyzw_8 = (-r0_xyz_3.xxxx + unity_ObjectToWorld[3]);
                float4 r3_xyzw_4 = (-r0_xyz_3.yyyy + unity_WorldToObject[0]);
                float4 r0_xyzw_4 = (-r0_xyz_3.zzzz + unity_WorldToObject[1]);
                float4 r3_xyzw_5 = (r3_xyzw_4 * r3_xyzw_4);
                float4 r3_xyzw_6 = mad(r1_xyzw_8, r1_xyzw_8, r3_xyzw_5);
                float4 r1_xyzw_9 = mad(r1_xyzw_8, unitWorldNormal_xyzw_5.xxxx, (unitWorldNormal_xyzw_5.yyyy * r3_xyzw_4));
                float4 r1_xyzw_10 = mad(r0_xyzw_4, unitWorldNormal_xyzw_5.wwzw, r1_xyzw_9);
                float4 r0_xyzw_5 = mad(r0_xyzw_4, r0_xyzw_4, r3_xyzw_6);
                float4 r0_xyzw_6 = max(r0_xyzw_5, float4(1E-06, 1E-06, 1E-06, 1E-06));
                float4 r3_xyzw_7 = rsqrt(r0_xyzw_6);
                float4 r0_xyzw_7 = mad(r0_xyzw_6, unity_WorldToObject[2], float4(1, 1, 1, 1));
                float4 r0_xyzw_8 = (float4(1, 1, 1, 1) / r0_xyzw_7);
                float4 r1_xyzw_11 = (r1_xyzw_10 * r3_xyzw_7);
                float4 r1_xyzw_12 = max(r1_xyzw_11, float4(0, 0, 0, 0));
                float4 r0_xyzw_9 = (r0_xyzw_8 * r1_xyzw_12);
                float3 r0_xyz_11 = (mad(cb1_values[10].xyzx, r0_xyzw_9.wwww, (mad(unity_WorldTransformParams.xyzx, r0_xyzw_9.zzzz, (mad(unity_WorldToObject[3].xyzx, r0_xyzw_9.xxxx, ((r0_xyzw_9.yyyy * cb1_values[8].xyzx)).xyzx)).xyzx)).xyzx)).xyz;
                float r0_w_11 = (unitWorldNormal_xyzw_5.y * unitWorldNormal_xyzw_5.y);
                float r0_w_12 = mad(unitWorldNormal_xyzw_5.x, unitWorldNormal_xyzw_5.x, -r0_w_11);
                float4 r2_xyzw_6 = (unitWorldNormal_xyzw_5.ywzx * unitWorldNormal_xyzw_5);
        ...
        Pass
        {
            ...
            program19Output vert(program19Input i)
            {
                ...
                float3 worldTangent_xyz_5 = (mad(unity_ObjectToWorld[0].yzxy, i.tangent0.xxxx, worldTangent_xyz_4.xyzx)).xyz;
                float3 worldTangent_xyz_6 = (mad(unity_ObjectToWorld[2].yzxy, i.tangent0.zzzz, worldTangent_xyz_5.xyzx)).xyz;
                float r1_w_6 = dot(worldTangent_xyz_6.xyzx, worldTangent_xyz_6.xyzx);
                float r1_w_7 = rsqrt(r1_w_6);
                float3 unitWorldTangent_xyz_7 = ((r1_w_7.xxxx * worldTangent_xyz_6.xyzx)).xyz;
                ...
                float3 clipPos_xyz_7 = (mad(cb0_values[4].xyzx, worldPos_xyzw_3.xxxx, clipPos_xyz_6.xyzx)).xyz;
                float3 clipPos_xyz_4 = (mad(cb0_values[6].xyzx, worldPos_xyzw_3.zzzz, clipPos_xyz_7.xyzx)).xyz;
                o.texcoord5.xyz = (mad(cb0_values[7].xyzx, worldPos_xyzw_3.wwww, clipPos_xyz_4.xyzx)).xyz;
                return o;
            }
            #pragma fragment frag
            program37Output frag(program37Input i)
            {
                ...
                float r1_w_1 = dot(r2_xyz_1.xyzx, r2_xyz_1.xyzx);
                float r1_w_2 = rsqrt(r1_w_1);
                float3 r2_xyz_2 = ((r1_w_2.xxxx * r2_xyz_1.xyzx)).xyz;
                float4 r3_xyzw_1 = t0.Sample(s2, i.texcoord0.xyxx);
                float4 r4_xyzw_1 = t1.Sample(s3, i.texcoord0.xyxx);
        ...
        Pass
        {
            ...
            program28Output vert(program28Input i)
            {
                ...
                float2 clipPos_xy_4 = (mad(cb0_values[4].xyxx, worldPos_xyzw_5.xxxx, clipPos_xy_3.xyxx)).xy;
                float2 clipPos_xy_5 = (mad(cb0_values[6].xyxx, worldPos_xyzw_5.zzzz, clipPos_xy_4.xyxx)).xy;
                o.texcoord5.xy = (mad(cb0_values[7].xxxy, worldPos_xyzw_5.wwww, clipPos_xy_5.xxxy)).zw;
                o.texcoord0.xy = (mad(i.texcoord0.xyxx, cb0_values[9].xyxx, cb0_values[9].zwzz)).xy;
                ...
                float r0_w_4 = dot(worldTangent_xyz_8.xyzx, worldTangent_xyz_8.xyzx);
                float r0_w_5 = rsqrt(r0_w_4);
                float3 unitWorldTangent_xyz_9 = ((r0_w_5.xxxx * worldTangent_xyz_8.xyzx)).xyz;
        ...
        Pass
        {
            ...
            program26Output vert(program26Input i)
            {
                ...
                float3 worldTangent_xyz_5 = (mad(unity_ObjectToWorld[0].yzxy, i.tangent0.xxxx, worldTangent_xyz_4.xyzx)).xyz;
                float3 worldTangent_xyz_6 = (mad(unity_ObjectToWorld[2].yzxy, i.tangent0.zzzz, worldTangent_xyz_5.xyzx)).xyz;
                float r1_w_7 = dot(worldTangent_xyz_6.xyzx, worldTangent_xyz_6.xyzx);
                float r1_w_8 = rsqrt(r1_w_7);
                float3 unitWorldTangent_xyz_7 = ((r1_w_8.xxxx * worldTangent_xyz_6.xyzx)).xyz;
                ...
                float4 clipPos_xyzw_8 = mad(cb0_values[4].xyzw, worldPos_xyzw_3.xxxx, clipPos_xyzw_7);
                float4 clipPos_xyzw_9 = mad(cb0_values[6].xyzw, worldPos_xyzw_3.zzzz, clipPos_xyzw_8);
                o.texcoord5.xyzw = mad(cb0_values[7].xyzw, worldPos_xyzw_3.wwww, clipPos_xyzw_9);
                return o;
            }
            #pragma fragment frag
        ...
        Pass
        {
            ...
            program25Output vert(program25Input i)
            {
                ...
                float3 worldTangent_xyz_5 = (mad(unity_ObjectToWorld[0].yzxy, i.tangent0.xxxx, worldTangent_xyz_4.xyzx)).xyz;
                float3 worldTangent_xyz_6 = (mad(unity_ObjectToWorld[2].yzxy, i.tangent0.zzzz, worldTangent_xyz_5.xyzx)).xyz;
                float r0_w_8 = dot(worldTangent_xyz_6.xyzx, worldTangent_xyz_6.xyzx);
                float r0_w_9 = rsqrt(r0_w_8);
                float3 unitWorldTangent_xyz_7 = ((r0_w_9.xxxx * worldTangent_xyz_6.xyzx)).xyz;
        ...
        Pass
        {
            ...
            program24Output vert(program24Input i)
            {
                ...
                float3 clipPos_xyz_8 = (mad(cb0_values[4].xyzx, worldPos_xyzw_3.xxxx, clipPos_xyz_7.xyzx)).xyz;
        ...
        Pass
        {
            ...
            program23Output vert(program23Input i)
            {
                ...
                float2 clipPos_xy_4 = (mad(cb0_values[4].xyxx, worldPos_xyzw_4.xxxx, clipPos_xy_3.xyxx)).xy;
                float2 clipPos_xy_5 = (mad(cb0_values[6].xyxx, worldPos_xyzw_4.zzzz, clipPos_xy_4.xyxx)).xy;
                o.texcoord5.xy = (mad(cb0_values[7].xxxy, worldPos_xyzw_4.wwww, clipPos_xy_5.xxxy)).zw;
                o.texcoord0.xy = (mad(i.texcoord0.xyxx, cb0_values[9].xyxx, cb0_values[9].zwzz)).xy;
                float worldNormal_y_6 = dot(i.normal0.xyzx, unity_WorldToObject[0].xyzx);
                float worldNormal_z_3 = dot(i.normal0.xyzx, unity_WorldToObject[1].xyzx);
                float worldNormal_x_6 = dot(i.normal0.xyzx, unity_WorldToObject[2].xyzx);
                ...
                float r0_w_4 = dot(worldTangent_xyz_7.xyzx, worldTangent_xyz_7.xyzx);
                float r0_w_5 = rsqrt(r0_w_4);
                float3 unitWorldTangent_xyz_8 = ((r0_w_5.xxxx * worldTangent_xyz_7.xyzx)).xyz;
                float r0_w_6 = (i.tangent0.w * unity_WorldTransformParams.w);
        ...
        Pass
        {
            ...
            program21Output vert(program21Input i)
            {
                ...
                float4 clipPos_xyzw_7 = mad(cb0_values[4].xyzw, worldPos_xyzw_3.xxxx, clipPos_xyzw_6);
                float4 clipPos_xyzw_8 = mad(cb0_values[6].xyzw, worldPos_xyzw_3.zzzz, clipPos_xyzw_7);
                o.texcoord5.xyzw = mad(cb0_values[7].xyzw, worldPos_xyzw_3.wwww, clipPos_xyzw_8);
                return o;
            }
            #pragma fragment frag
            program45Output frag(program45Input i)
        ...
        Pass
        {
            ...
            program20Output vert(program20Input i)
            {
                ...
                float3 worldTangent_xyz_5 = (mad(unity_ObjectToWorld[0].yzxy, i.tangent0.xxxx, worldTangent_xyz_4.xyzx)).xyz;
                float3 worldTangent_xyz_6 = (mad(unity_ObjectToWorld[2].yzxy, i.tangent0.zzzz, worldTangent_xyz_5.xyzx)).xyz;
                float r0_w_7 = dot(worldTangent_xyz_6.xyzx, worldTangent_xyz_6.xyzx);
                float r0_w_8 = rsqrt(r0_w_7);
                float3 unitWorldTangent_xyz_7 = ((r0_w_8.xxxx * worldTangent_xyz_6.xyzx)).xyz;
