    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program11Output frag(program11Input i)
            {
                ...
                float4 sampleMask_xyzw_1 = t1.Sample(s1, float4(uvMask_y_6, uvMask_z_2, uvMask_y_6, uvMask_y_6));
        ...
        Pass
        {
            ...
            program8Output vert(program8Input i)
            {
                ...
                float r0_w_6 = (clipPos_xyzw_2.y * _ProjectionParams.x);
                float2 r1_xz_3 = ((clipPos_xyzw_2.xxwx * float4(0.5, 0, 0.5, 0))).xz;
                float r1_w_3 = (r0_w_6 * 0.5);
                o.texcoord3.xy = ((r1_xz_3.yyyy + float4(r1_xz_3.x, r1_w_3, r1_xz_3.x, r1_xz_3.x))).xy;
                float r0_w_7 = (unitWorldNormal_xyz_5.y * unitWorldNormal_xyz_5.y);
                float r0_w_8 = mad(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.x, -r0_w_7);
                float4 r1_xyzw_4 = (unitWorldNormal_xyz_5.yzzx * unitWorldNormal_xyz_5.xyzz);
                float r3_x_1 = dot(cb2_values[42].xyzw, r1_xyzw_4);
                float r3_y_1 = dot(cb2_values[43].xyzw, r1_xyzw_4);
                float r3_z_1 = dot(cb2_values[44].xyzw, r1_xyzw_4);
                float4 r1_xyzw_5 = mad(cb2_values[45].xyzx, r0_w_8.xxxx, float4(r3_x_1, r3_y_1, r3_z_1, r3_x_1));
                float r1_x_5 = r1_xyzw_5.x;
                float r1_y_4 = r1_xyzw_5.y;
                float r1_z_5 = r1_xyzw_5.z;
                float r2_w_4 = 1;
                float r3_x_2 = dot(cb2_values[39].xyzw, float4(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.y, unitWorldNormal_xyz_5.z, r2_w_4));
                float r3_y_2 = dot(cb2_values[40].xyzw, float4(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.y, unitWorldNormal_xyz_5.z, r2_w_4));
                float r3_z_2 = dot(cb2_values[41].xyzw, float4(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.y, unitWorldNormal_xyz_5.z, r2_w_4));
                float4 r1_xyzw_6 = (float4(r1_x_5, r1_y_4, r1_z_5, r1_x_5) + float4(r3_x_2, r3_y_2, r3_z_2, r3_x_2));
                float r1_x_6 = r1_xyzw_6.x;
                float r1_y_5 = r1_xyzw_6.y;
                float r1_z_6 = r1_xyzw_6.z;
                float4 r1_xyzw_7 = max(float4(r1_x_6, r1_y_5, r1_z_6, r1_x_6), float4(0, 0, 0, 0));
                float r1_x_7 = r1_xyzw_7.x;
                float r1_y_6 = r1_xyzw_7.y;
                float r1_z_7 = r1_xyzw_7.z;
                float4 r1_xyzw_8 = log2(float4(r1_x_7, r1_y_6, r1_z_7, r1_x_7));
                float r1_x_8 = r1_xyzw_8.x;
                float r1_y_7 = r1_xyzw_8.y;
                float r1_z_8 = r1_xyzw_8.z;
                float4 r1_xyzw_9 = (float4(r1_x_8, r1_y_7, r1_z_8, r1_x_8) * float4(0.41666666, 0.41666666, 0.41666666, 0));
                float r1_x_9 = r1_xyzw_9.x;
                float r1_y_8 = r1_xyzw_9.y;
                float r1_z_9 = r1_xyzw_9.z;
                float4 r1_xyzw_10 = exp2(float4(r1_x_9, r1_y_8, r1_z_9, r1_x_9));
                float r1_x_10 = r1_xyzw_10.x;
                float r1_y_9 = r1_xyzw_10.y;
                float r1_z_10 = r1_xyzw_10.z;
                float4 r1_xyzw_11 = mad(float4(r1_x_10, r1_y_9, r1_z_10, r1_x_10), float4(1.055, 1.055, 1.055, 0), float4(-0.055, -0.055, -0.055, 0));
                float r1_x_11 = r1_xyzw_11.x;
                float r1_y_10 = r1_xyzw_11.y;
                float r1_z_11 = r1_xyzw_11.z;
                float4 r1_xyzw_12 = max(float4(r1_x_11, r1_y_10, r1_z_11, r1_x_11), float4(0, 0, 0, 0));
                float r1_x_12 = r1_xyzw_12.x;
                float r1_y_11 = r1_xyzw_12.y;
                ...
                float4 r2_xyzw_6 = mad(r0_xyzw_5, unitWorldNormal_xyz_5.zzzz, mad(r5_xyzw_1, unitWorldNormal_xyz_5.xxxx, (unitWorldNormal_xyz_5.yyyy * r3_xyzw_3)));
                ...
                float4 r2_xyzw_7 = (r2_xyzw_6 * r3_xyzw_6);
                float4 r2_xyzw_8 = max(r2_xyzw_7, float4(0, 0, 0, 0));
                float4 r0_xyzw_10 = (r0_xyzw_9 * r2_xyzw_8);
                float3 r0_xyz_12 = (mad(cb2_values[10].xyzx, r0_xyzw_10.wwww, (mad(cb2_values[9].xyzx, r0_xyzw_10.zzzz, (mad(unity_WorldToObject[3].xyzx, r0_xyzw_10.xxxx, ((r0_xyzw_10.yyyy * cb2_values[8].xyzx)).xyzx)).xyzx)).xyzx)).xyz;
                o.texcoord4.xyz = ((r0_xyz_12.xyzx + float4(r1_x_12, r1_y_11, r1_z_12, r1_x_12))).xyz;
                o.texcoord7.xyzw = float4(0, 0, 0, 0);
                return o;
            }
            #pragma fragment frag
            program13Output frag(program13Input i)
            {
                ...
                float r0_y_9 = (r0_y_8 * r0_y_8);
                float r0_y_10 = (r0_y_9 * r0_z_3);
                float4 r0_xyzw_11 = (-i.texcoord2.xxyz + _WorldSpaceCameraPos.xxyz);
                float r0_y_11 = r0_xyzw_11.y;
                float r0_z_4 = r0_xyzw_11.z;
                float r0_w_2 = r0_xyzw_11.w;
                float4 r0_xyzw_12 = (float4(r0_y_11, r0_y_11, r0_z_4, r0_w_2) * (rsqrt(dot(float4(r0_y_11, r0_z_4, r0_w_2, r0_y_11), float4(r0_y_11, r0_z_4, r0_w_2, r0_y_11)))).xxxx);
                float r0_y_12 = r0_xyzw_12.y;
                float r0_z_5 = r0_xyzw_12.z;
                float r0_w_3 = r0_xyzw_12.w;
                float r0_y_13 = dot(i.texcoord1.xyzx, float4(r0_y_12, r0_z_5, r0_w_3, r0_y_12));
                float r0_z_6 = ((float4(1, 1, 1, 1) / _Softness)).z;
                float r0_y_14 = (r0_z_6 * abs(r0_y_13));
                float r0_z_7 = mad(r0_y_14, -2, 3);
                float r0_y_15 = (r0_y_14 * r0_y_14);
        ...
        Pass
        {
            ...
            program13Output frag(program13Input i)
            {
                program13Output o = (program13Output)0;
                float2 uvMask2_xy_1 = (mad(i.texcoord0.xyxx, _Mask2_ST.xyxx, _Mask2_ST.zwzz)).xy;
                float4 sampleMask2_xyzw_3 = t0.Sample(s0, (mad(_Time.yyyy, _Mask2Speed.xyxx, uvMask2_xy_1.xyxx)).xyxx);
                float r0_y_4 = ((float4(1, 1, 1, 1) / _MaskSoftness2)).y;
                float r0_x_4 = (r0_y_4 * sampleMask2_xyzw_3.x);
                float r0_y_5 = mad(r0_x_4, -2, 3);
                float4 uvMask_xyzw_6 = mad(i.texcoord0.xxyx, _Mask_ST.xxyx, _Mask_ST.zzwz);
                float uvMask_y_6 = uvMask_xyzw_6.y;
                float uvMask_z_2 = uvMask_xyzw_6.z;
                ...
                float viewDir_z_4 = viewDir_xyzw_11.z;
                float viewDir_w_2 = viewDir_xyzw_11.w;
                float4 r0_xyzw_12 = (float4(viewDir_y_11, viewDir_y_11, viewDir_z_4, viewDir_w_2) * (rsqrt(dot(float4(viewDir_y_11, viewDir_z_4, viewDir_w_2, viewDir_y_11), float4(viewDir_y_11, viewDir_z_4, viewDir_w_2, viewDir_y_11)))).xxxx);
                float r0_y_12 = r0_xyzw_12.y;
                float r0_z_5 = r0_xyzw_12.z;
                float r0_w_3 = r0_xyzw_12.w;
                float r0_y_13 = dot(i.texcoord1.xyzx, float4(r0_y_12, r0_z_5, r0_w_3, r0_y_12));
        ...
        Pass
        {
            ...
            program5Output vert(program5Input i)
            {
                ...
                o.texcoord2.xyz = (r0_xyz_4.xyzx).xyz;
                float r0_w_6 = (clipPos_xyzw_2.y * _ProjectionParams.x);
                float r3_w_1 = (r0_w_6 * 0.5);
                float2 r3_xz_1 = ((clipPos_xyzw_2.xxwx * float4(0.5, 0, 0.5, 0))).xz;
                o.texcoord3.zw = (clipPos_xyzw_2.zzzw).zw;
                o.texcoord3.xy = ((r3_xz_1.yyyy + float4(r3_xz_1.x, r3_w_1, r3_xz_1.x, r3_xz_1.x))).xy;
                float r0_w_7 = (unitWorldNormal_xyz_5.y * unitWorldNormal_xyz_5.y);
                float r0_w_8 = mad(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.x, -r0_w_7);
                float4 r1_xyzw_3 = (unitWorldNormal_xyz_5.yzzx * unitWorldNormal_xyz_5.xyzz);
                float r3_x_2 = dot(cb2_values[42].xyzw, r1_xyzw_3);
                float r3_y_1 = dot(cb2_values[43].xyzw, r1_xyzw_3);
                float r3_z_2 = dot(cb2_values[44].xyzw, r1_xyzw_3);
                float r2_w_4 = 1;
                float r3_x_3 = dot(cb2_values[39].xyzw, float4(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.y, unitWorldNormal_xyz_5.z, r2_w_4));
                float r3_y_2 = dot(cb2_values[40].xyzw, float4(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.y, unitWorldNormal_xyz_5.z, r2_w_4));
                float r3_z_3 = dot(cb2_values[41].xyzw, float4(unitWorldNormal_xyz_5.x, unitWorldNormal_xyz_5.y, unitWorldNormal_xyz_5.z, r2_w_4));
                float3 r1_xyz_8 = (((log2((max((((mad(cb2_values[45].xyzx, r0_w_8.xxxx, float4(r3_x_2, r3_y_1, r3_z_2, r3_x_2))).xyzx + float4(r3_x_3, r3_y_2, r3_z_3, r3_x_3))).xyzx, float4(0, 0, 0, 0))).xyzx)).xyzx * float4(0.41666666, 0.41666666, 0.41666666, 0))).xyz;
                float4 r3_xyzw_4 = (-r0_xyz_4.yyyy + unity_WorldToObject[0]);
                float4 r3_xyzw_5 = (r3_xyzw_4 * r3_xyzw_4);
                float4 r5_xyzw_1 = (-r0_xyz_4.xxxx + unity_ObjectToWorld[3]);
                float4 r0_xyzw_5 = (-r0_xyz_4.zzzz + unity_WorldToObject[1]);
                float4 r2_xyzw_6 = mad(r0_xyzw_5, unitWorldNormal_xyz_5.zzzz, mad(r5_xyzw_1, unitWorldNormal_xyz_5.xxxx, (unitWorldNormal_xyz_5.yyyy * r3_xyzw_4)));
                float4 r3_xyzw_6 = mad(r5_xyzw_1, r5_xyzw_1, r3_xyzw_5);
                float4 r0_xyzw_6 = mad(r0_xyzw_5, r0_xyzw_5, r3_xyzw_6);
                float4 r0_xyzw_7 = max(r0_xyzw_6, float4(1E-06, 1E-06, 1E-06, 1E-06));
                float4 r3_xyzw_7 = rsqrt(r0_xyzw_7);
                float4 r0_xyzw_8 = mad(r0_xyzw_7, unity_WorldToObject[2], float4(1, 1, 1, 1));
                float4 r0_xyzw_9 = (float4(1, 1, 1, 1) / r0_xyzw_8);
                float4 r2_xyzw_7 = (r2_xyzw_6 * r3_xyzw_7);
                float4 r2_xyzw_8 = max(r2_xyzw_7, float4(0, 0, 0, 0));
                float4 r0_xyzw_10 = (r0_xyzw_9 * r2_xyzw_8);
                float3 r0_xyz_12 = (mad(cb2_values[10].xyzx, r0_xyzw_10.wwww, (mad(cb2_values[9].xyzx, r0_xyzw_10.zzzz, (mad(unity_WorldToObject[3].xyzx, r0_xyzw_10.xxxx, ((r0_xyzw_10.yyyy * cb2_values[8].xyzx)).xyzx)).xyzx)).xyzx)).xyz;
                o.texcoord4.xyz = ((r0_xyz_12.xyzx + (max((mad((exp2(r1_xyz_8.xyzx)).xyzx, float4(1.055, 1.055, 1.055, 0), float4(-0.055, -0.055, -0.055, 0))).xyzx, float4(0, 0, 0, 0))).xyzx)).xyz;
                o.texcoord7.xyzw = float4(0, 0, 0, 0);
                return o;
            }
            #pragma fragment frag
        ...
        Pass
        {
            ...
            program29Output frag(program29Input i)
            {
                ...
                float4 sampleTexcoord_xyzw_1 = t1.Sample(s1, float4(uvTexcoord_y_6, uvTexcoord_z_2, uvTexcoord_y_6, uvTexcoord_y_6));
        ...
        Pass
        {
            ...
            program43Output frag(program43Input i)
            {
                ...
                float4 r0_xyzw_13 = t3.Sample(s3, float4(r0_x_12, r0_y_24, r0_z_11, r0_x_12));
