    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program3Output frag(program3Input i)
            {
                ...
                float4 r0_xyzw_1 = _MainTex.Sample(sampler_MainTex, (i.texcoord2.xyxx).xy);
                float r0_y_2 = dot(r0_xyzw_1.xyzx, float4(0.22, 0.707, 0.071, 0));
                float4 r1_xyzw_1 = _MainTex.Sample(sampler_MainTex, (i.texcoord4.xyxx).xy);
                float r1_z_2 = dot(r1_xyzw_1.xyzx, float4(0.22, 0.707, 0.071, 0));
                float r0_x_2 = r1_z_2;
                float4 r2_xyzw_1 = _MainTex.Sample(sampler_MainTex, (i.texcoord5.xyxx).xy);
                ...
                float4 r2_xyzw_2 = _MainTex.Sample(sampler_MainTex, (i.texcoord3.xyxx).xy);
                float r2_y_3 = dot(r2_xyzw_2.xyzx, float4(0.22, 0.707, 0.071, 0));
                float4 r3_xyzw_1 = _MainTex.Sample(sampler_MainTex, (i.texcoord6.xyxx).xy);
                float r0_y_3 = dot(r3_xyzw_1.xyzx, float4(0.22, 0.707, 0.071, 0));
                float r2_x_3 = r0_y_3;
                float4 r3_xyzw_2 = _MainTex.Sample(sampler_MainTex, (i.texcoord7.xyxx).xy);
                ...
                float4 r3_xyzw_3 = _MainTex.Sample(sampler_MainTex, (i.texcoord1.xyxx).xy);
                ...
                float4 r1_xyzw_3 = _MainTex.Sample(sampler_MainTex, (i.texcoord0.xyxx).xy);
                ...
                float4 r2_xyzw_5 = _MainTex.Sample(sampler_MainTex, (r1_zw_4.xyxx).xy);
                float2 r1_zw_5 = ((r1_xy_4.xxxy * float4(0, 0, 0.5, 0.5))).zw;
                float4 r3_xyzw_4 = _MainTex.Sample(sampler_MainTex, (r1_zw_5.xyxx).xy);
                ...
                float4 r3_xyzw_5 = _MainTex.Sample(sampler_MainTex, (r1_zw_6.xyxx).xy);
                ...
                float4 r1_xyzw_5 = _MainTex.Sample(sampler_MainTex, (float4(r0_x_7, r0_z_4, r0_x_7, r0_x_7)).xy);
                float4 r0_xyzw_8 = _MainTex.Sample(sampler_MainTex, (float4(r0_y_6, r0_w_4, r0_y_6, r0_y_6)).xy);
