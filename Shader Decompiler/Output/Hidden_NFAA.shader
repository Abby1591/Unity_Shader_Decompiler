    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program4Output frag(program4Input i)
            {
                ...
                float r0_x_3 = dot(r1_xyzw_3.xyzx, float4(0.22, 0.707, 0.071, 0));
                float r2_x_4 = (dot(float4(1, 1, 1, 0), float4(r0_x_3, r0_y_3, r0_z_2, r0_x_3)) + r0_w_3);
                float4 r0_xyzw_5 = (float4(r2_x_4, r2_y_4, r2_x_4, r2_x_4) * _BlurRadius.xxxx);
                float r0_x_5 = r0_xyzw_5.x;
                float r0_y_4 = r0_xyzw_5.y;
                float4 r0_xyzw_6 = (float4(r0_x_5, r0_y_4, r0_x_5, r0_x_5) * float4(0.5, 0.5, 0, 0));
                float r0_x_6 = r0_xyzw_6.x;
                float r0_y_5 = r0_xyzw_6.y;
                float r0_z_3 = 0.5;
                float4 r0_xyzw_7 = (float4(r0_x_6, r0_y_5, r0_z_3, r0_x_6) + float4(0.5, 0.5, 0.5, 0));
                float r0_x_7 = r0_xyzw_7.x;
                float r0_y_6 = r0_xyzw_7.y;
                float r0_z_4 = r0_xyzw_7.z;
                float r0_w_4 = dot(float4(r0_x_7, r0_y_6, r0_z_4, r0_x_7), float4(r0_x_7, r0_y_6, r0_z_4, r0_x_7));
                float r0_w_5 = rsqrt(r0_w_4);
                o.sv_Target0.xyz = ((r0_w_5.xxxx * float4(r0_x_7, r0_y_6, r0_z_4, r0_x_7))).xyz;
                o.sv_Target0.w = 1;
                return o;
            }
            ENDHLSL
