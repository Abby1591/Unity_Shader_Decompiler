    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program76Output frag(program76Input i)
            {
                ...
                float r0_w_4 = rsqrt(r0_w_3);
                float3 unitWorldNormal_xyz_1 = ((r0_w_4.xxxx * i.texcoord1.xyzx)).xyz;
                float r0_x_5 = (max(dot(unitWorldNormal_xyz_1.xyzx, ((r0_w_2.xxxx * viewDir_xyz_1.xyzx)).xyzx), 0) + 1);
                float r0_y_3 = (-cb0_values[9].w + cb0_values[9].z);
                float r0_y_4 = max(r0_y_3, 0);
                float r0_z_3 = (-r0_y_4 + r0_x_5);
                float r0_w_5 = (cb0_values[9].w + cb0_values[9].z);
        ...
        Pass
        {
            ...
            program74Output frag(program74Input i)
            {
                ...
                float r0_y_6 = r0_xyzw_9.y;
                float r0_z_3 = r0_xyzw_9.z;
                float4 viewDir_xyzw_6 = (-i.texcoord0.xyzx + _WorldSpaceCameraPos.xyzx);
                float viewDir_x_6 = viewDir_xyzw_6.x;
                float viewDir_y_4 = viewDir_xyzw_6.y;
                float viewDir_z_4 = viewDir_xyzw_6.z;
                float r1_w_2 = dot(float4(viewDir_x_6, viewDir_y_4, viewDir_z_4, viewDir_x_6), float4(viewDir_x_6, viewDir_y_4, viewDir_z_4, viewDir_x_6));
                float r1_w_3 = rsqrt(r1_w_2);
                float4 unitViewDir_xyzw_7 = (r1_w_3.xxxx * float4(viewDir_x_6, viewDir_y_4, viewDir_z_4, viewDir_x_6));
                float unitViewDir_x_7 = unitViewDir_xyzw_7.x;
                float unitViewDir_y_5 = unitViewDir_xyzw_7.y;
                float unitViewDir_z_5 = unitViewDir_xyzw_7.z;
                float r1_x_10 = (max(dot(unitWorldNormal_xyz_1.xyzx, float4(unitViewDir_x_7, unitViewDir_y_5, unitViewDir_z_5, unitViewDir_x_7)), 0) + 1);
                float r1_y_6 = (-cb0_values[9].w + cb0_values[9].z);
                float r1_y_7 = max(r1_y_6, 0);
                float r1_z_6 = (-r1_y_7 + r1_x_10);
                float r1_w_4 = (cb0_values[9].w + cb0_values[9].z);
