    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program1Output vert(program1Input i)
            {
                ...
                float4 sampleMMap_xyzw_5 = t0.SampleLevel(s0, float4(uvMMap_x_4, uvMMap_y_3, uvMMap_x_4, uvMMap_x_4), 0);
            ...
            program3Output frag(program3Input i)
            {
                ...
                float4 r2_xyzw_4 = t0.Sample(s2, r1_yz_2.xyxx);
                float r0_w_5 = (-_mask_type + 1);
                float TEXCOORD0_x_2 = i.texcoord0.x;
                float4 r1_xyzw_4 = t1.Sample(s3, (mad(float4(TEXCOORD0_x_2, r3_y_1, TEXCOORD0_x_2, TEXCOORD0_x_2), ((cos(r0_x_3) * _M_map_ST.y)).xxxx, ((r0_xy_4.x * _M_map_ST.w)).xxxx)).xyxx);
                ...
                if (r0_yw_6.x)
                {
                    ...
                    float4 sampleDiffuse_xyzw_7 = t2.Sample(s0, uvDiffuse_xy_6.xyxx);
                ...
                if (r0_yw_6.y)
                {
                    float4 r1_xyzw_9 = t3.Sample(s1, float4(TEXCOORD0_x_2, r3_y_1, TEXCOORD0_x_2, TEXCOORD0_x_2));
