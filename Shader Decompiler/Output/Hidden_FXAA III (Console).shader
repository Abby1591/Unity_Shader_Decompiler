    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            program3Output frag(program3Input i)
            {
                ...
                float4 r1_xyzw_1 = _MainTex.Sample(sampler_MainTex, (i.texcoord1.xwxx).xy);
                float r0_y_2 = dot(r1_xyzw_1.xyzx, float4(0.22, 0.707, 0.071, 0));
                float4 r1_xyzw_2 = _MainTex.Sample(sampler_MainTex, (i.texcoord1.zyzz).xy);
                float r0_z_2 = dot(r1_xyzw_2.xyzx, float4(0.22, 0.707, 0.071, 0));
                float4 r1_xyzw_3 = _MainTex.Sample(sampler_MainTex, (i.texcoord1.zwzz).xy);
                float r0_w_2 = dot(r1_xyzw_3.xyzx, float4(0.22, 0.707, 0.071, 0));
                float4 r1_xyzw_4 = _MainTex.Sample(sampler_MainTex, (i.texcoord0.xyxx).xy);
                ...
                if (r1_w_8)
                {
                    ...
                    float4 r3_xyzw_2 = _MainTex.Sample(sampler_MainTex, (float4(r0_z_4, r0_w_3, r0_z_4, r0_z_4)).xy);
                    ...
                    float4 r4_xyzw_1 = _MainTex.Sample(sampler_MainTex, (float4(r0_z_5, r0_w_4, r0_z_5, r0_z_5)).xy);
                    ...
                    float4 r5_xyzw_1 = _MainTex.Sample(sampler_MainTex, (float4(r0_z_8, r0_w_5, r0_z_8, r0_z_8)).xy);
                    ...
                    float4 r0_xyzw_11 = _MainTex.Sample(sampler_MainTex, (float4(r0_x_10, r0_y_8, r0_x_10, r0_x_10)).xy);
